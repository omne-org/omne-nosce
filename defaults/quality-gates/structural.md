...
- [ ] `skills/` directory exists and contains at least one `<name>/SKILL.md` file
...
- [ ] No directory exceeds 2 levels of nesting from image root (`skills/<name>/SKILL.md` is 2 levels)
